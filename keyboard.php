...
$optionPasarguardReseller = json_encode([
    'keyboard' => [
        ...
        [['text' => "🔗 ویرایش آدرس پنل"], ['text' => "🧩 نقش پیش‌فرض فروش"]],
        ...
        [['text' => "👥 فهرست نماینده‌ها"], ['text' => "📦 پلن‌های نمایندگی"]],
        [['text' => "⏳ بررسی سرویس‌های منقضی"], ['text' => "🔄 تازه‌سازی اتصال"]],
        [['text' => "🔌 تست اتصال پنل"], ['text' => "📋 نقش‌های پنل"]],
        [['text' => $textbotlang['Admin']['backadmin']], ['text' => $textbotlang['Admin']['backmenu']]],
    ],
    'resize_keyboard' => true,
...
$optionX_ui_single = json_encode([
    'keyboard' => [
        ...
        [['text' => "✍️ نام پنل"], ['text' => "❌ حذف پنل"]],
        [['text' => "🔐 ویرایش رمز عبور"], ['text' => "👤 ویرایش نام کاربری"]],
        [['text' => "🔑 ویرایش توکن API"], ['text' => "🧩 نسخه API سنایی"]],
        [['text' => "🔗 ویرایش آدرس پنل"], ['text' => "🔋 روش تمدید سرویس"]],
        [['text' => "🎨 تنظیم رنگ پنل"], ['text' => "⭐ تنظیم ایموجی پرمیوم"]],
